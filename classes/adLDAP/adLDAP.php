...
class adLDAP {
    ...
    * @var string
    */   
	protected $_account_suffix = "@cpo.unicamp.br";
    ...
    * @var string
    */
	protected $_base_dn = "DC=cpo,DC=unicamp,DC=br"; 
    ...
    * @var string
    */
	protected $_ad_username='sistema-gerencial';
    protected $_ad_password='sistema-gerencial';
