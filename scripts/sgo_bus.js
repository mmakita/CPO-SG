...
function listarObras(obra){
	if(obra.length == 0) {
		...
		$.each(obra, function(i){
			$("#listaObrasRes").append('<tr class="c"><td class="c"><a href="javascript:void(0)" onclick="javascript:window.open(\'sgo.php?acao=ver&amp;obraID='+obra[i].id+'\',\'obra_det\',\'width=900,height=650,scrollbars=yes,resizable=yes\')"><b>' + obra[i].nome + '</b></a><br />' + obra[i].unidade.compl + '</td></tr>');
		});
	}
}
