...
<body onload="showGMap()" style="border-width: 0; padding: 0; background-image: none; padding: 0; margin: 0;">
	...
	<div class="alert" id="alert"><span style="color: red; font-weight: bold">Atenção:</span> Algumas obras sem coordenadas foram encontradas. Para visualizá-las, selecione o modo lista.</div>
