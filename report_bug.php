<?php
	...
	$html->content[1] = '<script type="text/javascript" src="scripts/reportbug.js"></script>';
	...
	function montaBugForm(){
		...
		$html = '
		<form action="report_bug.php?acao=enviar" method="post">
	...
	function verTabBugs($bd){
		$html = '<br/><span class="header">Erros já reportados:</span><br/>';
